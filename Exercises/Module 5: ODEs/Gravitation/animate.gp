...
set xrange [-5:5]  # Adjust these ranges to better fit your data if necessary
set yrange [-5:5]
set zrange [0:25]
...
do for [i=0:int(n)-1] {
    splot "gravitation_2.dat" every ::0::i u 2:3:4 w l lw 2 lc rgb "blue" title 'Body 1', \
          "gravitation_2.dat" every ::0::i u 5:6:7 w l lw 2 lc rgb "green" title 'Body 2', \
          "gravitation_2.dat" every ::0::i u 8:9:10 w l lw 2 lc rgb "red" title 'Body 3'
}
